...
int	main()
{
  ...
  printf("OK (xpm %dx%d)(textures bpp2: %d, sizeline2: %d endian: %d type: %d)\n",
	 xpm1_x,xpm1_y,bpp2,sl2,endian2,((t_textures *)im2)->type);
  sleep(2);
